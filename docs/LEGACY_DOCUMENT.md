...
```bash
npm install github:mxhiraz/onai-sdk#v0.1.19
```
...
{
  "dependencies": {
    "onai-sdk": "github:mxhiraz/onai-sdk#v0.1.19"
  }
}
```
...
```bash
npm install git+https://github.com/mxhiraz/onai-sdk.git#v0.1.19
```
