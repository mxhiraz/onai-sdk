...
The single SDK guide is [docs/LEGACY_DOCUMENT.md](docs/LEGACY_DOCUMENT.md). It includes installation, configuration, structured logging, request headers, uploads, products, characters, image generation, beta video generation, raw GraphQL, security rules, and maintenance policy.
